...
- (void)getStreamRecordings:(NSString *)streamId byPassword:(NSString *)password withCompletionHandler:(void (^)(NSError* error, NSArray* recordings))completion;
- (void)getStreamRecordings:(NSString *)streamId byTicket:(NSString *)ticket withCompletionHandler:(void (^)(NSError* error, NSArray* recordings))completion;
